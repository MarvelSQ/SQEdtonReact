...
function handleSelection(sl) {
  ...
  // let text = sl.extentNode.innerText?sl.extentNode.innerText:sl.extentNode.parentNode.innerText;
  // if()
  // console.log('extent', text?text:sl.extentNode.parentNode.innerText);
  if (paras.length === 0) {
